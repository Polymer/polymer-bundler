...
var JS = 'script:not([type]), script[type="text/javascript"], script[type="application/javascript"]';
...
module.exports = {
  ...
  NEW_POLYMER_ERROR: 'Found "dom-module" element. Vulcanize 0.7 does not support Polymer > 0.5'
};
