...
Vulcan.prototype = {
  ...
  inlineScripts: function inlineScripts(doc, href) {
    ...
    var scriptPromises = scripts.map(function(script) {
      ...
      var filePath = path.resolve(this.pathResolver.urlToPath(uri));
      return this.loader.request(filePath).then(function(content) {
        if (content) {
  ...
  inlineCss: function inlineCss(doc, href) {
    ...
    var cssPromises = css_links.map(function(link) {
      var tag = link;
      var rel = dom5.getAttribute(tag, 'rel');
      ...
      return this.loader.request(filePath).then(function(content) {
        if (content) {
          ...
          if (rel === 'import') {
            dom5.setAttribute(style, 'is', 'custom-style');
          }
