...
function buildLoader(abspath, excludes, redirects) {
...
var Vulcan = function Vulcan(opts) {
  ...
  this.redirects = Array.isArray(opts.redirect) ? opts.redirect : [];
  if (!opts.loader) {
    this.loader = buildLoader(this.abspath, this.excludes, this.redirects);
  } else {
...
Vulcan.prototype = {
  ...
  getImplicitExcludes: function getImplicitExcludes(excludes) {
    ...
    var loader = buildLoader(this.abspath, null, this.redirects);
