...
var REMOTE_ABS_URL = require('./constants.js').REMOTE_ABS_URL;
...
function processOptions(options, callback) {
  ...
  options.webAbsPath = options.webAbsPath || config.webAbsPath;
  if (options.webAbsPath) {
    options.webAbsPath = path.resolve(options.webAbsPath);
